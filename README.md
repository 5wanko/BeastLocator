...
>**「はえ～、すっごい大きい…」**<br>
<br>
野獣邸の方角を知れる、ただそれだけのアプリです<br>
野獣邸は基本的に、聖地巡礼することはタブーとされており、実際野獣の日に来るなという公式の声明も出ています<br>
そんな野獣邸を身近に感じたかったので、このアプリを作りました
...
## 主な機能
 ...
 - 野獣邸への方角・距離表示
 - 野獣邸までの直線距離を表示するウィジェット
 - 野獣邸到達時の通知
 - 野獣邸から一定の距離に達した際、強制的に音声を再生　~~やめてくれよ...~~

## その他の機能

さすがに野獣邸に実際に行って動作確認するのはまずいので、デバッグメニューから目的地の座標を変更できるようにしています<br>
...
とりあえずMIT Licenseにしています  
なので、基本的に自由にいじくってもらってOKです
