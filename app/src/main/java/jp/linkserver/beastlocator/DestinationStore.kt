...
class DestinationStore(context: Context) {
    ...
    fun isAutoGeneratedOssEnabled(): Boolean =
        prefs.getBoolean(KEY_AUTO_GENERATED_OSS_ENABLED, DEFAULT_AUTO_GENERATED_OSS_ENABLED)

    fun setAutoGeneratedOssEnabled(enabled: Boolean) {
        prefs.edit().putBoolean(KEY_AUTO_GENERATED_OSS_ENABLED, enabled).apply()
    }
    ...
    fun getGeocodingProvider(): GeocodingProvider {
        return GeocodingProvider.fromPref(prefs.getString(KEY_GEOCODING_PROVIDER, null))
    }

    fun setGeocodingProvider(provider: GeocodingProvider) {
        prefs.edit().putString(KEY_GEOCODING_PROVIDER, provider.prefValue).apply()
    }
    ...
    companion object {
        ...
        private const val KEY_AUTO_GENERATED_OSS_ENABLED = "auto_generated_oss_enabled"
        ...
        private const val KEY_GEOCODING_PROVIDER = "geocoding_provider"
        ...
        private const val DEFAULT_AUTO_GENERATED_OSS_ENABLED = true
