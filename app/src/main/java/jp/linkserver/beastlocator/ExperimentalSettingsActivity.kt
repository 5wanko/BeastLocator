...
class ExperimentalSettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val autoGeneratedOssSwitch = findViewById<MaterialSwitch>(R.id.autoGeneratedOssSwitch)
        ...
        autoGeneratedOssSwitch.isChecked = store.isAutoGeneratedOssEnabled()
        autoGeneratedOssSwitch.setOnCheckedChangeListener { _, isChecked ->
            store.setAutoGeneratedOssEnabled(isChecked)
        }
